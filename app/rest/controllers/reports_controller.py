"""
app/rest/controllers/reports_controller.py
-------------------------------------------
...
from app.model.services import reports as service
from app.model.services.reports import exporters
from app.rest.common.helpers import safe_int
...
def export_users_csv():
    ...
    users = service.get_users_report_all(
        ...
        role_id=safe_int(args.get("role_id"), "role_id"),
...
def export_projects_csv():
    ...
    projects = service.get_projects_report_all(
        search=args.get("q", "").strip() or None,
        owner_id=safe_int(args.get("owner_id"), "owner_id"),
